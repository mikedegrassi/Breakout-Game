...
let gameInfoH2 = document.querySelector(".demoh2");
let gameInfoP = document.querySelector(".demop");
let gameInfoButton = document.querySelector(".startbutton");
...
function draw() {
    ...
    gameInfoButton.classList.remove("startbutton");
    gameInfoButton.classList.add("none");

    gameInfoH2.innerHTML = ""
    gameInfoP.innerHTML = ""
